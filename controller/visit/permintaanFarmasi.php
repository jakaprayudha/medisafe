...
function getData()
{
   ...
   $query = "SELECT permintaan_pharmacy.*, 
                    ms_pharmacy.pharmacy_name_generic, 
                    ms_pharmacy.pharmacy_name_trade, 
                    ms_pharmacy.pharmacy_sale AS harga
             FROM permintaan_pharmacy 
             INNER JOIN ms_pharmacy 
                ON ms_pharmacy.id_pharmacy = permintaan_pharmacy.id_pharmacy
...
function  getID($iduser)
{
   ...
   $query = "SELECT * FROM permintaan_pharmacy  INNER JOIN ms_pharmacy ON ms_pharmacy.id_pharmacy = permintaan_pharmacy.id_pharmacy  WHERE id_permintaan_farmasi = ?";
