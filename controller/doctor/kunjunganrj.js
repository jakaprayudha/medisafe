...
$(function () {
  ...
  $("#kdStatusPulang").select2({
    ...
    data: [
      ...
      {
        id: "A",
        text: "Rujuk Atas Permintaan Sendiri (APS)",
      },
      {
        id: "1",
        text: "Meninggal",
      ...
      success: function (res) {
        if (res.status === "success" && res.data.length > 0) {
          ...
          if (res.pasienStatus == "UMUM") {
            ...
            $('#ToogleStPulang').addClass('d-none');
  ...
  $("#kdStatusPulang").on("change", function () {
    ...
    if (idstatus == "4" && StatusPasien == "BPJS") {
      ...
      $('input[name="kdStatusRujuk"][value="SP"]')
        .prop("checked", true)
        .trigger("change");
      chackTacc();
      loadRujukan();
  ...
  function TrigerSP() {
    ...
    $("#useSarana").on("change", function () {
      if ($(this).is(":checked")) {
        ...
        console.log("tidak");
        $("#kdSarana").val("9").trigger("change").prop("disabled", true);
  ...
  function checkRujuk(subSpesialis, kdkhSpesialis) {
    if (subSpesialis != null && statusEdit == true) {
      ...
      $('input[name="kdStatusRujuk"][value="KH"]')
        .prop("checked", true)
        .trigger("change");
      triggerKH();
    }
