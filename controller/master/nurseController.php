...
function createData()
{
   ...
   // Ambil semua field yang valid untuk tabel ms_nurse
   $allowedFields = [
      'nurse_name',
      'nurse_profesi',
      'nurse_category',
   ...
   $fields = ['nurse_number']; // tambahkan nurse_number
...
/**
 * Generate nurse_number unik dengan format DCT-XXXXXX
 */
...
function getData()
{
   ...
   $query = "SELECT * FROM ms_nurse ORDER BY nurse_name DESC";
...
function  getID($iduser)
{
   ...
   $query = "SELECT * FROM ms_nurse WHERE id_nurse = ?";
...
function updateData()
{
   ...
   $query = "UPDATE ms_nurse SET " . implode(',', $fields) . " WHERE id_nurse=?";
...
function deleteData()
{
   ...
   $query = "DELETE FROM ms_nurse WHERE id_nurse = ?";
