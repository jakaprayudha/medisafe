...
foreach ($clinics as $clinic) {
    ...
    foreach ($patientVisits as $patient) {
        ...
        $url = $fhirUrl . "/Encounter/$patient[id_encounter]";
        ...
        if (!$id_encounter) {
            ...
            echo "Failed to create Encounter masuk ruangan for patient visit ID: $id_pasien_visit. Error: $error\n";
            continue;
        }
        ...
        // update data
        mysqli_query($koneksi, "UPDATE pasien_visit SET is_masuk_ruangan='1' WHERE id_visit='$id_pasien_visit'");
        echo "Updated Encounter masuk ruangan with ID: $id_encounter for patient visit ID: $id_pasien_visit\n";
    }
}

echo "Encounter masuk ruangan success";
