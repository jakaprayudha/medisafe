    ...
    $response = [
        ...
        "data" => [
            [
                ...
                "deskripsiAlergiMakan" => $hasil['desAlMakan'],
                "deskripsiAlergiUdara" => $hasil['desAlUdara'],
                "deskripsiAlergiObat" => $hasil['desAlObat']
            ]
        ]
    ];
