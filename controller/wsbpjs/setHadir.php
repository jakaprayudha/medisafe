...
if ($status_hadir != '1') {
    mysqli_query($koneksi, "UPDATE pasien_visit SET visit_status = '99' WHERE visit_ID = '$visit_id' AND id_customer = '$idcustomer'");
} else {
    mysqli_query($koneksi, "UPDATE pasien_visit SET visit_status = '1' WHERE visit_ID = '$visit_id' AND id_customer = '$idcustomer'");
}
if ($stmt1->execute()) {
    echo json_encode([
        'success' => true,
