...
$getorder = tampildata("SELECT * FROM transaction_order_details INNER JOIN product ON transaction_order_details.id_product = product.id WHERE transaction_order_details.status_item!='2' AND transaction_order_details.id_transacation='$id' AND transaction_order_details.code='$code' ");
