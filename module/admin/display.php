              ...
              <div class="col-md-3">
                <div class="card border h-100">
                  <div class="card-body text-center">
                    ...
                    <a href="module/display/display-farmasi.php" target="_blank" class="btn btn-outline-success btn-sm">
                      Buka Display
                    </a>
                  </div>
                </div>
              ...
              <div class="col-md-3">
                <div class="card border h-100">
                  <div class="card-body text-center">
                    ...
                    <a href="module/display/display-poliklinik.php" target="_blank" class="btn btn-outline-info btn-sm">
                      Buka Display
                    </a>
                  </div>
                </div>
              ...
              <div class="col-md-3">
                <div class="card border h-100">
                  <div class="card-body text-center">
                    ...
                    <a href="module/display/display-applicare.php" target="_blank" class="btn btn-outline-warning btn-sm">
                      Buka Display
                    </a>
                  </div>
                </div>
