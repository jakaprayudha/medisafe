            ...
            <div class="col-lg-12 d-flex align-items-stretch">
              <div class="card w-100">
                <div class="card-body p-4">
                  ...
                  <h4 class="mb-3">Surat Keterangan Rawat Inap</h4>
                  <!-- Data Pasien -->
                  <div class="row">
                    <p>Yang Bertanda tangan dibawah ini</p>
                    <div class="col-3">
                      <div class="mb-3">
                        <label for="number_letter" class="form-label">No.Surat Keterangan</label>
                        <input type="text" value="<?= $data['number_letter'] ?>" id="number_letter" required name="number_letter" class="form-control">
                      </div>
                    </div>
                    <div class="col-3">
                      <div class="mb-3">
                        <label for="letter_sign" class="form-label">Nama</label>
                        <input type="text" value="<?= $data['letter_sign'] ?>" id="letter_sign" required name="letter_sign" class="form-control">
                      </div>
                    </div>
                    <div class="col-3">
                      <div class="mb-3">
                        <label for="letter_sign_position" class="form-label">Jabatan</label>
                        <input type="text" value="<?= $data['letter_sign_position'] ?>" id="letter_sign_position" required name="letter_sign_position" class="form-control">
                      </div>
                    </div>
