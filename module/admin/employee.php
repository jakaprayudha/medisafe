            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <a href="module/admin/employee">
                  <button class="nav-link active" id="office-tab" type="button" role="tab" aria-controls="office-tab-pane" aria-selected="true">Karyawan Kantor</button>
                </a>
              </li>
              <li class="nav-item" role="presentation">
                <a href="module/admin/employee_sales">
                  <button class="nav-link" id="sales-tab" type="button" role="tab" aria-controls="sales-tab-pane" aria-selected="false">Karyawan Sales</button>
                </a>
              </li>
            </ul>
...
<script>
  ...
  const apiUrl = '<?php echo $apiUrl . 'employee/' . 'employeeOfficeController' ?>';
  $(document).ready(function() {
