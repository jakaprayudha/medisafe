        ...
        <div class="row">
          <div class="col-6">
            <div class="mb-3">
              ...
              <input type="text" id="provider_code" name="provider_code" class="form-control" required>
            </div>
          </div>
          <div class="col-6">
            <div class="mb-3">
...
<script>
  const apiUrl = 'controller/master/providerController';
  ...
  $(document).ready(function() {
    ...
    $(document).on('change', '.toggle-status', function() {
      ...
      fetch(apiUrl + '?toggle_status=1', {
          ...
          body: `id_provider=${id}&provider_status=${status}`
        })
        .then(res => res.json())
        .then(res => {
