<nav class="sidebar-nav scroll-sidebar" data-simplebar="">
   <ul id="sidebarnav">
      ...
      <li class="sidebar-item">
         <a class="sidebar-link <?php if ($title == 'List Pasien') {echo 'active';} ?>"
            href="module/admisi/listPasien"
            aria-expanded="false">
            <iconify-icon icon="solar:checklist-minimalistic-linear"></iconify-icon>
            <span class="hide-menu">List Admisi</span>
         </a>
      </li>
      <!-- <li class="sidebar-item">
      ...
      <li class="sidebar-item">
         <a class="sidebar-link <?php if ($title == 'Display Tiket') {echo 'active';} ?>"
