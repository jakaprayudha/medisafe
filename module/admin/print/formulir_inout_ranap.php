...
<div class="ranap-section">
  ...
  <table class="ranap-table">
    <tr>
      ...
      <td id="diagnosa_medik"></td>
    </tr>
    <tr>
      <td>Diagnosa Akhir</td>
      <td>
        Utama: <span id="diagnosa_utama"></span><br>
...
<div class="ranap-section">
  ...
  <table class="ranap-table">
    <tr><td width="30%">Alergi</td><td id="alergi"></td></tr>
    <tr><td>Infeksi Nosokomial</td><td id="infeksi_nosokomial"></td></tr>
    <tr><td>Penyebab Infeksi</td><td id="penyebab_infeksi"></td></tr>
    <tr><td>Keadaan Keluar</td><td class="ranap-highlight" id="keadaan_keluar"></td></tr>
    <tr><td>Cara Keluar</td><td id="cara_keluar"></td></tr>
    <tr><td>Dokter Merawat</td><td class="ranap-highlight" id="dokter_merawat"></td></tr>
  </table>
</div>
