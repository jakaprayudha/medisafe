...
<head>
   <meta charset="UTF-8">
   <title>Perjalanan Perkembangan Penyakit</title>
   <style>
      @page {
         size: A4;
         margin: 1.5cm;
...
<body>
   ...
   <table>
      <tr class="center" style="font-weight:bold;">
         ...
         <td width="25%">Permintaan dokter dan pengobatan tindakan medik</td>
         <td width="15%">Tanda tangan dokter</td>
      </tr>
      <tr class="big-cell">
         <td></td>
         <td></td>
