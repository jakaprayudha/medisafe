            ...
            <div class="col-lg-12 d-flex align-items-stretch">
              <div class="card w-100">
                <div class="card-body p-4">
                  ...
                  <h4 class="mb-3">Form Upload Buku Kesehatan Ibu dan Anak</h4>
                  <!-- Data Pasien -->
                  <div class="row">
                    <div class="col-3">
                      <div class="mb-3">
                  ...
                  <div class="mt-3 text-center">
                    <div id="listFotoKIA" class="mt-3 text-right"></div>
                  </div>

                  <div class="text-end mt-2">
                    <button type="button" class="btn btn-outline-success" id="btnFoto" data-bs-toggle="modal" data-bs-target="#modalUpload">
      ...
      <form id="formUpload" enctype="multipart/form-data">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Upload Foto Pasien</h5>
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="file" name="file_foto" id="file_foto" class="form-control" accept="image/*" required>
            </div>

            <div class="text-center">
              <img id="previewImg" src="" class="img-thumbnail" style="max-width:250px; display:none;">
            </div>
...
<script>
  ...
  $("#formUpload").submit(function(e) {
    ...
    $.ajax({
      url: "controller/visit/uploadKIA.php",
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
      success: function(res) {
        ...
        if (json.status === "success") {
          ...
          $("#fotoPasien").attr("src", json.file_url).show();
  ...
  window.onload = function() {
    const rm = $("input[name='nomor_rm']").val();
    const visit = $("input[name='nomor_visit']").val();

    console.log("RM:", rm);
    console.log("Visit:", visit);
    $.get("controller/visit/getFotoKIA.php?rm=" + rm + "&visit=" + visit, function(res) {
      let json = JSON.parse(res);
      console.log(json);
      ...
      if (json.status === "success") {
        ...
        json.files.forEach(function(url) {
          $("#listFotoKIA").append(`
                <img src="${url}" class="img-thumbnail m-2" style="max-width:150px;">
            `);
        });
      }
    });
